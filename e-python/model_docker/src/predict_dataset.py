...
def uploadStatsToBlob(client_blob_folder,
    ...
    print("Time to upload josn file is")        
...
def get_prediction(docInput):
    ...
    try:
        ...
        print("Time to upload pred file is")
...
def predict(docInput):
    ...
    print("Content details:", auth_token, sub_id, content['body'])
    ...
    try:
        ...
        if not logfile.closed:
            ...
            print("Time to upload model.log is")

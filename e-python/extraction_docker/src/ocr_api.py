...
def ocrApi(docInput):
    ...
    pageDetailsOcr = json.loads(content['body'])
    # content_body = content_body.get("request")
    documentId = pageDetailsOcr["documentId"]
    totalNoPages = pageDetailsOcr["totalNoPages"]
    pageNumber = pageDetailsOcr["pageNumber"]
    ...
    std_out = sys.stdout
    std_err = sys.stderr
    logfilepath = str(documentId) + "_page_" + str(pageNumber) + "_ocr.log"
    ...
    try:
        ...
        ocr_result["pages"] = pageDetailsOcr
        ...
        print("OCR API:",traceback.print_exc())
        return returnFailure(client_blob_folder, 
                             auth_token,
                             sub_id,
                             documentId,
        ...
        if not logfile.closed:
            ...
            try:
                ...
                pass
            if uploaded:
                print("OCR log file uploaded to Blob")

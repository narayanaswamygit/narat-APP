...
def get_blob_account_details_old(sub_id):
        ...
        try:
            ...
            print("get_blob_account_details_old",
                  traceback.print_exc())
            return None,None,None
...
def get_blob_account_details(sub_id):
    ...
    try:
        ...
        print("get_blob_account_details",
              traceback.print_exc())
        return None,None,None
...
def downloadFilesFromBlobStore(sub_id,
    ...
    try:
        ...
        print("downloadFilesFromBlobStore",
              traceback.print_exc())
        return False
@timing
def searchFilesBlobStore(sub_id,
                         prefix):
    ...
    try:
        ...
        blob_service_client = BlobServiceClient(account_url = account_url,
                                                credential = credential)
        print("Search Files From Blob Store")

        blob_client = blob_service_client.list_blobs(container_name = container_name,
                                                     prefix = prefix,
                                                     delimiter = "")
        print(list(blob_client))
        return list(blob_client)
    except:
        print("searchFilesBlobStore",
              traceback.print_exc())
        return None
@timing
...
def remove_rupee_symbol(text):
    ...
    try:
        ...
        print("Removing rupee  sysmbol from text exception :",
              traceback.print_exc())
...
def isAmount(s):
    try:
        ...
        # ptn8 giving FP on amount if there is two mob no printed followed by ","
        # So added the check lenth 
        if (len(s)<=15):
            for ptn in ptns:
                l = re.findall(ptn,s)
...
def getlabelKeywords_nonTokenized():  # to preProcUtilies files
    try:
        ...
        print("getlabelKeywords_nonTokenized",
              traceback.print_exc())
        return None
...
def getlabelKeywords_nonTokenized_new():  # to preProcUtilies files
    try:
        ...
        print("getlabelKeywords_nonTokenized_new",
              traceback.print_exc())
        return None

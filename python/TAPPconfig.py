...
def getAWS_ACCESS_KEY_ID():
    return configdata['AWS_ACCESS_KEY_ID']

def getAWS_SECRET_ACCESS_KEY():
    return configdata['AWS_SECRET_ACCESS_KEY']
...
def getS3_UPLOAD_TABLE():
    return configdata['S3_UPLOAD_TABLE']

def getNonSLAVendorFilePath():
    return configdata['NON_SLA_VENDOR']

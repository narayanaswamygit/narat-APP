...
improper_data_type_sql = True
# Code to connect to SQL Database
conn = psycopg2.connect(
   database="swginsta_pAIges", user='swginsta_admin@swginstapaiges', password='jQ0y]QcA0Qv.p]D',
   host='swginstapaiges.postgres.database.azure.com',
   port= '5432'
)
...
table_rpa_metadata = "swiggy_posting_data_"
table_document_metadata = "swiggy_prod_document_metadata"
table_document_result = "swiggy_prod_document_result"

...
from client_rules import get_vendorGSTIN_from_docApiInfoInp, add_non_sla_vendor_flag
...
def updateSuccess(status,
    ...
    ## Adding nonSlaVendorFlag 30 Mar 2023
    vendorGSTIN = get_vendorGSTIN_from_docApiInfoInp(docApiInfoInp)
    docApiInfo["request"]["nonSLAVendorFlag"] = add_non_sla_vendor_flag(vendorGSTIN=vendorGSTIN)
    print("non Sla venndor flag :",docApiInfo["request"]["nonSLAVendorFlag"])
    ## Adding nonSlaVendorFlag 30 Mar 2023
